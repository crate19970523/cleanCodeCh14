...
public class Args {
    ...
    private void parseSchema(String schema) throws ArgsException {
        for (var element : schema.split(",")) if (element.length() > 0) parseSchemaElement(element.trim());
    }
...
//        else if (elementTail.equals("##")) marshalers.put(elementI
////        else if (elementTail.equals("[*]")) marshalers.put(elementId, new StringArrayArgumentMarshaler());d, new DoubleArgumentMarshaler());
